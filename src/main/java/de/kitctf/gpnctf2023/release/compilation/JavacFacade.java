package de.kitctf.gpnctf2023.release.compilation;
...
public class JavacFacade {
   ...
   */
  public static Map<String, byte[]> compileFiles(Map<String, String> files,
    ...
    return manager.getAll().entrySet().stream()
